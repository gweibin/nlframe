package com.nlinks.nlframe.widget.segment;
...
public class SegmentControl extends View {
    ...
    public SegmentControl(Context context, AttributeSet attrs, int defStyle) {
        ...
        DEFAULT_SELECTED_COLOR = ta.getColor(R.styleable.SegmentControl_selectColor, DEFAULT_SELECTED_COLOR);
