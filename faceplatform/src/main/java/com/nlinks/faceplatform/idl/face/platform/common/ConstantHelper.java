 ...
 */
package com.nlinks.faceplatform.idl.face.platform.common;
...
public class ConstantHelper {
    ...
    public static final String LOG_CATE = "ca"; // 分类

    public static final String LOG_OS = "system"; // 系统信息
    public static final String LOG_DE = "device"; // 设备信息
    public static final String LOG_VS = "version"; // 版本信息
    public static final String LOG_APPID = "appid"; // 应用信息

    public static final String LOG_STM = "stm"; // 打开界面
    public static final String LOG_FTM = "ftm"; // 第一次检测到人脸
    public static final String LOG_BTM = "btm"; // 第一次满足Detect条件
    public static final String LOG_PTM = "ptm"; // 第一次检测到动作
    public static final String LOG_ETM = "etm"; // 检测完成
    public static final String LOG_FINISH = "finish"; // 完成检测流程
    public static final String LOG_LV = "lv"; // 活体动作
    public static final String LOG_MSG = "msg"; // 文字语音提示次数
