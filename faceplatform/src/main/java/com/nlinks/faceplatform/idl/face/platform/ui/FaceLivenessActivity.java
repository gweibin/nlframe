 ...
 */
package com.nlinks.faceplatform.idl.face.platform.ui;
...
import com.nlinks.faceplatform.R;
import com.nlinks.faceplatform.idl.face.platform.FaceConfig;
import com.nlinks.faceplatform.idl.face.platform.FaceSDKManager;
...
import com.nlinks.faceplatform.idl.face.platform.utils.APIUtils;
import com.nlinks.faceplatform.idl.face.platform.utils.Base64Utils;
import com.nlinks.faceplatform.idl.face.platform.utils.CameraPreviewUtils;
import com.nlinks.faceplatform.idl.face.platform.utils.CameraUtils;
import com.nlinks.faceplatform.idl.face.platform.utils.VolumeUtils;
...
public class FaceLivenessActivity extends Activity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
            ...
            PermissionUtils.permission(Manifest.permission.CAMERA)
                    .callback(new PermissionUtils.SimpleCallback() {
                        ...
                        public void onDenied() {
                            ToastUtils.showShort("人脸认证需要相机权限");
                            finish();
                        }
                    });
        }
        ...
        mSoundView.setImageResource(mIsEnableSound ?
                R.drawable.ic_enable_sound_ext : R.drawable.ic_disable_sound_ext);
    ...
    private void onRefreshTipsView(boolean isAlert, String message) {
        if (isAlert) {
            if (mTipsIcon == null) {
                mTipsIcon = getResources().getDrawable(R.drawable.ic_warning);
