...
import com.nlinks.faceplatform.idl.face.platform.utils.DensityUtils;
...
public class FaceDetectRoundView extends View {
    ...
    public static final int COLOR_RECT = Color.parseColor("#04c3d9");
    public static final int COLOR_ROUND = Color.parseColor("#04c3d9");
    ...
    private float mY;
    private float mR;
    private boolean mIsDrawDash = false;
